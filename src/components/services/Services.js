    ...
    return (
        <div >
            ...
            <div className='servisecCardContainer1'>
               <div className='services2'> <ServiceCard title="search phone" desc="Lorem Ipsum is simply dummy text of the printing" /></div>
               <div className='services3'> <ServiceCard title="your profile" desc="Lorem Ipsum is simply dummy text of the printing" /></div>
            </div>
        </div>
    )
}
